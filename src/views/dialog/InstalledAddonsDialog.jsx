...
import FetchAddonsDialog from "./FetchAddonsDialog";
import AddonConfigDialog from "./AddonConfigDialog";
import InstalledAddon from "../../components/InstalledAddon";
...
export default function InstalledAddonsDialog(props) {
    ...
    function renderInstalledAddonsList() {
        if (installedAddons === undefined || installedAddons.size < 1) {
            return
        }
    ...
    useEffect(() => {
        if (!props.open) {
            //console.log("installed addon dialog closed")
            setFetchAddonsShow(false)
            setAddonConfigShow(false)
        } else {
            //console.log("installed addon dialog opened")
